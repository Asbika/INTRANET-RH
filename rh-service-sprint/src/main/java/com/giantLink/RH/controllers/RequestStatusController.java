...
public class RequestStatusController {
    ...
    @PutMapping("/update_rquest/status/{requestId}")
    public ResponseEntity<RequestStatusResponse> updateRequestStatus(
            @PathVariable Long requestId,
            @RequestBody RequestStatusRequest requestStatusRequest
    ) {
        RequestStatusResponse updatedStatus = requestStatusService.updateRequestStatus(requestId, requestStatusRequest);
