...
import com.giantLink.RH.services.impl.PayrollProcessingService;
...
public class PayrollController {
    ...
    @PostMapping
    @PreAuthorize("hasRole('ADMIN_RH') and hasAnyAuthority('ADMIN_CREATE')")
    ...
    @PreAuthorize("hasRole('ADMIN_RH') and hasAnyAuthority('ADMIN_UPDATE')")
    ...
    @PreAuthorize("hasAnyRole('ADMIN_RH','MANAGER_RH','DIRECTOR') and hasAnyAuthority('ADMIN_READ' ,'MANAGER_READ')")
