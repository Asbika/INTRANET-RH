...
//        if (employeeRepository.count() > 0) return;
        ...
        Employee employee1 = Employee.builder()
                ...
                .recrutementDate(new Date("1998/5/3"))
                .build();
        Employee employee2 = Employee.builder()
                ...
                .cin("z555888")
                .recrutementDate(new Date("2005/08/22"))
                .build();
        ...
        Employee employee4 = Employee.builder()
                ...
                .recrutementDate(new Date("2012/12/8"))
                .build();
        Employee employee5 = Employee.builder()
                ...
                .recrutementDate(new Date("2020/10/13"))
                .build();
        ...
        Employee employee7 = Employee.builder()
                ...
                .recrutementDate(new Date("2009/7/7"))
                .build();
        ...
        payroll1.setSalary(1000.0f);
        payroll1.setPaymentDate(new Date("2020/10/13"));

        Payroll payroll2 = new Payroll();
        payroll2.setEmployee(employee2);
        payroll2.setSalary(1500.0f);
        payroll2.setPaymentDate(new Date("2020/11/13"));

        Payroll payroll3 = new Payroll();
        payroll3.setEmployee(employee3);
        payroll3.setSalary(1000.0f);
        payroll3.setPaymentDate(new Date("2020/06/13"));

        Payroll payroll4 = new Payroll();
        payroll4.setEmployee(employee4);
        payroll4.setSalary(1500.0f);
        payroll4.setPaymentDate(new Date("2020/03/13"));

        Payroll payroll5 = new Payroll();
        payroll5.setEmployee(employee5);
        payroll5.setSalary(1500.0f);
        payroll5.setPaymentDate(new Date("2020/05/13"));

        Payroll payroll6 = new Payroll();
        payroll6.setEmployee(employee6);
        payroll6.setSalary(1500.0f);
        payroll6.setPaymentDate(new Date("2020/10/16"));

        Payroll payroll7 = new Payroll();
        payroll7.setEmployee(employee7);
        payroll7.setSalary(1500.0f);
        payroll7.setPaymentDate(new Date("2020/12/19"));
        ...
        payrollRepository.saveAll(Arrays.asList(
                payroll1,
                payroll2,
                payroll3,
                payroll4,
    ...
    public void initRoles() {
        ...
        Permission readPermissionEmployee = Permission.builder().namePermission("EMPLOYEE_READ").build();
        Permission updatePermissionEmployee= Permission.builder().namePermission("EMPLOYEE_UPDATE").build();
        Permission createPermissionEmployee = Permission.builder().namePermission("EMPLOYEE_CREATE").build();
        Permission deletePermissionEmployee = Permission.builder().namePermission("EMPLOYEE_DELETE").build();
        ...
        Role employee = Role.builder().roleName("EMPLOYEE").build();
        ...
        roleService.addPermissionToRole(1L, 4L);
        roleService.addPermissionToRole(1L, 13L); // EMPLOYEE_READ
        roleService.addPermissionToRole(1L, 14L); // EMPLOYEE_UPDATE
        roleService.addPermissionToRole(1L, 15L); // EPLOYEE_CREATE
        roleService.addPermissionToRole(1L, 16L); // EPLOYEE_DELETE
        ...
        roleService.addPermissionToRole(2L, 13L); // EMPLOYEE_READ
        roleService.addPermissionToRole(2L, 14L); // EMPLOYEE_UPDATE
        roleService.addPermissionToRole(2L, 15L); // EPLOYEE_CREATE
        roleService.addPermissionToRole(2L, 16L); // EPLOYEE_DELETE
        ...
        roleService.addPermissionToRole(4L, 13L); // EMPLOYEE_READ
        roleService.addPermissionToRole(4L, 14L); // EMPLOYEE_UPDATE
        roleService.addPermissionToRole(4L, 15L); // EPLOYEE_CREATE
        roleService.addPermissionToRole(4L, 16L); // EPLOYEE_DELETE
        ...
        roleService.addPermissionToRole(5L, 13L);
        roleService.addPermissionToRole(5L, 14L);
        roleService.addPermissionToRole(5L, 15L);
        roleService.addPermissionToRole(5L, 16L);
        ...
        Employee employee_admin = Employee.builder()
                ...
                .recrutementDate(new Date("2004/11/2"))
                .build();
    ...
    public void initPredefinedHoliday() {
        ...
        holiday_3.setNumberOfDays(1);        holiday_3.setStartDate(new Date());
