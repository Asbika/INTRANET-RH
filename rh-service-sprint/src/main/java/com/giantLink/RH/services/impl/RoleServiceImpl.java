...
public class RoleServiceImpl  implements RoleService {
    ...
    public RoleResponse add(RoleRequest request) {
        ...
        if (findRole.isPresent()) {
            throw new ResourceDuplicatedException(findRole.getClass().getSimpleName(), "id", findRole.get().getId().toString());
        }else{
        Role role = new Role();
    ...
    public RoleResponse update(RoleRequest request, Long id) {
        ...
        if(!findRole.isPresent()){
            throw  new ResourceNotFoundException(findRole.getClass().getSimpleName(),"id",id.toString());
        }
