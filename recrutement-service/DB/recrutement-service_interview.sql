...
CREATE TABLE `interview` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_tqkqf1w6du1g6qcyjqskb036e` (`candidate_id`),
  UNIQUE KEY `UK_ebhliag1fbk8axafcfs50ruv3` (`evaluation_id`),
  CONSTRAINT `FKjod0wwyxvbi7qyx9cmlnt8xq4` FOREIGN KEY (`candidate_id`) REFERENCES `candidate` (`id`),
  CONSTRAINT `FKt11kvrvkahpbe95wltbghtssg` FOREIGN KEY (`evaluation_id`) REFERENCES `evaluation` (`id`)
...
-- Dump completed on 2024-03-14 10:05:16
